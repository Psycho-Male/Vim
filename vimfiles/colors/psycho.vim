...
call s:h("LoglevelInfo",    {"fg": s:black          ,"bg": s:purple                                 , "format": "bold"})
call s:h("LoglevelDebug",   {"fg": s:black          ,"bg": s:green                                  , "format": "bold"})
call s:h("LoglevelError",   {"fg": s:black          ,"bg": s:red                                    , "format": "bold"})
call s:h("LoglevelWarn",    {"fg": s:black          ,"bg": s:yellow                                 , "format": "bold"})
call s:h("LoglevelFatal",   {"fg": s:black          ,"bg": s:orange                                 , "format": "bold"})
call s:h("LoglevelTrace",   {"fg": s:black          ,"bg": s:teal                                   , "format": "bold"})
