...
call s:h("LoglevelInfo",    {"fg": s:fg                          , "format": "none"})
call s:h("LoglevelDebug",   {"fg": s:fg                          , "format": "none"})
call s:h("LoglevelError",   {"fg": s:fg                          , "format": "none"})
call s:h("LoglevelWarn",    {"fg": s:fg                          , "format": "none"})
call s:h("LoglevelFatal",   {"fg": s:fg                          , "format": "none"})
call s:h("LoglevelTrace",   {"fg": s:fg                          , "format": "none"})
call s:h("LogTimeStamp",    {"fg": s:fg                          , "format": "none"})
call s:h("LogNumber",       {"fg": s:fg                          , "format": "none"})
